...
> * **mostDamageUnjustified** -- 6th arg/parameter /_**boolean**_/ = is **true** if killer recieved _**unjustified**_ from most damage to creature, **false if not** [//](/broken/pages/4LBzVXkRqScfqvROcBCB): #
